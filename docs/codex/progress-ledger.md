...
- Status: In Progress
- Next Action: commit SBI #30, open PR, update Project evidence, and merge to `dev`
...
|---|---|---|---|---|
| Issue #30 | codex/sbi-30-csv-export | pending | In Progress | PR and Project evidence update |
