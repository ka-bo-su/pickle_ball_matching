...
- Current SBI: #80 参加者一覧に出席状態の内訳を表示する
...
- Project number: `3`
- Last successful validation: 2026-06-05 15:26 JST, local `scripts/codex/validate-ios.sh` on Issue #80 branch.
...
- Next action: commit Issue #80, push branch, create PR, verify CI, merge if green, and keep Project pending updates until `gh` authentication is restored.
