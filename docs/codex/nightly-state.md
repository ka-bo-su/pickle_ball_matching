...
- Current SBI: #78 ラウンド生成前の準備ガイドと無料版目安を表示する
...
- Project number: `3`
- Last successful validation: 2026-06-05 15:10 JST, local `scripts/codex/validate-ios.sh` on Issue #78 branch.
...
- Next action: verify PR #79 CI, merge if green, and keep Project pending updates until `gh` authentication is restored.
