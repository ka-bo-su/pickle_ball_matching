...
- Project number: `3`
- Last successful validation: 2026-06-01 04:20 JST, `scripts/codex/validate-ios.sh` on `codex/sbi-21-operation-round`
- Current blocker: none
- Next action: open and merge Issue #21 PR, then continue with local JSON persistence or manual swap/undo.
