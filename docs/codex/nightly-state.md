...
- Current PBI: selecting next MVP PBI
- Current SBI: selecting next safe SBI
- Active branch: dev
...
- Project number: `3`
- Last successful validation: 2026-06-02 08:07 JST, GitHub Actions `validate` on PR #57
- Current blocker: none
- Next action: select the next safe MVP SBI from Project/Sprint Backlog.
