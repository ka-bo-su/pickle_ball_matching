...
- Partially completed: Issue #78 pre-round readiness guidance and free-plan notice are implemented, fully validated, and opened as PR #79; GitHub Actions/merge are pending.
