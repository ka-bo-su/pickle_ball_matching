...
| SBI-014 | 参加者の性別・年齢帯・メモを編集できるようにする | In Progress | swift-developer | `scripts/codex/validate-ios.sh` passed locally | Issue #38 |
...
19. Issue #38 selected and implemented locally; PR creation is next.
