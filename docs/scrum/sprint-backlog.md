...
| SBI-016 | 現在ラウンド内の任意プレイヤーを入れ替えられるようにする | In Progress | swift-developer | `scripts/codex/validate-ios.sh` passed locally | Issue #42 |
...
21. Issue #42 selected and implemented locally; PR creation is next.
