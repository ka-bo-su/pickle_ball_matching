...
| SBI-011 | 参加者向け大画面ボードを表示する | In Review | swift-developer | `scripts/codex/validate-ios.sh` passed locally | PR #33, Issue #32 |
...
16. Issue #32 implemented locally, PR #33 opened, and Project item moved to In Review.
