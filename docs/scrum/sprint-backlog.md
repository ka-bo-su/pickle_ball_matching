...
| SBI-016 | 現在ラウンド内の任意プレイヤーを入れ替えられるようにする | In Review | swift-developer | `scripts/codex/validate-ios.sh`, GitHub Actions pending | PR #43, Issue #42 |
...
21. Issue #42 opened as PR #43 and Project item moved to In Review.
