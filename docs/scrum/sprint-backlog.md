...
| SBI-017 | 複数手Undo履歴で手動修正を戻せるようにする | In Review | swift-developer | `scripts/codex/validate-ios.sh`, GitHub Actions pending | PR #45, Issue #44 |
...
22. Issue #44 opened as PR #45 and Project item moved to In Review.
