...
| SBI-028 | ラウンド履歴で過去ラウンドとスコアを確認できるようにする | In Progress | swift-developer | `scripts/codex/validate-ios.sh` | Issue #68 |
...
34. Issue #68 selected, implemented locally, and validated; PR creation is next.

## Next Ready Work

| ID | Type | Status | Owner Role | Validation | Evidence |
|---|---|---|---|---|---|
| SBI-028 | ラウンド履歴で過去ラウンドとスコアを確認できるようにする | In Progress | swift-developer | `scripts/codex/validate-ios.sh` passed | Issue #68 |
