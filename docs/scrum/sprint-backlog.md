...
| SBI-012 | セッション名と運営条件を編集できるようにする | In Review | swift-developer | `scripts/codex/validate-ios.sh` passed locally | PR #35, Issue #34 |
...
17. Issue #34 implemented locally, PR #35 opened, and Project item moved to In Review.
