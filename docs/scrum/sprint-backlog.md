...
| SBI-029 | 参加者名をまとめて貼り付けて追加できるようにする | In Review | swift-developer | `scripts/codex/validate-ios.sh` passed locally | PR #71, Issue #70 |
...
35. Issue #70 selected, locally implemented, validated, and PR #71 opened.
