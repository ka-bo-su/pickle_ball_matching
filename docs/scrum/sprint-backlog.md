...
| SBI-011 | 参加者向け大画面ボードを表示する | In Progress | swift-developer | `scripts/codex/validate-ios.sh` passed locally | Issue #32 |
...
16. Issue #32 selected and implemented locally; PR is next.
