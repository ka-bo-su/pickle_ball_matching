...
| SBI-009 | 待機者との手動入れ替えと1手戻す | In Progress | swift-developer | `scripts/codex/validate-ios.sh` passed locally | Issue #27 |
...
14. Issue #27 selected and implemented locally; PR is next.
