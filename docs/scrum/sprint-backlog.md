...
| SBI-010 | 現在ラウンドをCSVで共有できるようにする | In Progress | swift-developer | `scripts/codex/validate-ios.sh` passed locally | Issue #30 |
...
15. Issue #30 selected and implemented locally; PR is next.
