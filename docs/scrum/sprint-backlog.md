...
| CHORE-007 | GitHub ActionsのNode 20 deprecation警告を解消する | In Progress | swift-developer | `scripts/codex/validate-ios.sh` passed | Issue #54 |
...
27. Issue #54 selected and local validation passed; PR creation pending.

## Next Ready Work

| ID | Type | Status | Owner Role | Validation | Evidence |
|---|---|---|---|---|---|
| CHORE-007 | GitHub Actions Node 20 deprecation warning対応 | In Progress | swift-developer | `scripts/codex/validate-ios.sh`, GitHub Actions pending | Issue #54 |
