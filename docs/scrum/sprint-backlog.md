...
| SBI-009 | 待機者との手動入れ替えと1手戻す | In Review | swift-developer | `scripts/codex/validate-ios.sh` passed locally; GitHub Actions running | PR #28, Issue #27 |
...
14. Issue #27 selected, implemented locally, and opened as PR #28.
