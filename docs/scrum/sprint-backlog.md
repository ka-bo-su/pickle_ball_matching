...
| SBI-022 | 進行ボードで試合開始と残り時間を扱えるようにする | In Progress | swift-developer | pending due execution blocker | Issue #56 |
...
28. Issue #56 selected and local timer implementation started on `codex/sbi-56-round-timer`.

## Next Ready Work

| ID | Type | Status | Owner Role | Validation | Evidence |
|---|---|---|---|---|---|
| SBI-022 | 進行ボードで試合開始と残り時間を扱えるようにする | In Progress | swift-developer | ViewModel/UI tests, `scripts/codex/validate-ios.sh` | Issue #56 |
