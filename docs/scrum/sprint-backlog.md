...
| SBI-015 | 保存済み名簿から新規セッションを開始できるようにする | In Progress | swift-developer | `scripts/codex/validate-ios.sh` passed locally | Issue #40 |
...
20. Issue #40 selected and implemented locally; PR creation is next.
