...
| SBI-020 | 過去セッションを一覧から再開できるようにする | In Review | swift-developer | `scripts/codex/validate-ios.sh`, GitHub Actions pending | PR #51, Issue #50 |
...
25. Issue #50 opened as PR #51 and Project item moved to In Review.
