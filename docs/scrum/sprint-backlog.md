...
| SBI-013 | 参加者レベルを編集して組み合わせに反映する | In Progress | swift-developer | `scripts/codex/validate-ios.sh` passed locally | Issue #36 |
...
18. Issue #36 selected and implemented locally; PR is next.
