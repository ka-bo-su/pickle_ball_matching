...
| SBI-029 | SBI | 参加者名をまとめて貼り付けて追加できるようにする | P0 | In Review | PR #71, Issue #70; Done sync pending execution quota |
| SBI-030 | SBI | 大画面ボードに残り時間とラウンド状態を表示する | P1 | In Progress | Issue #72, local branch `codex/sbi-72-large-board-timer` |
